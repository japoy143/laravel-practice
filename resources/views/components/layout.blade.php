...
-->
    <div class="min-h-full">
                ...
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <x-nav-link href="{{ route('jobs.index') }}" :active="request()->is('jobs.index')">Jobs</x-nav-link>
                    ...
                    <div class="hidden md:block">
                        <div class="ml-4 flex items-center md:ml-6">
                            ...
                            @auth
                                {{-- prefferably use send a post to logout not just use anchor tag --}}
            ...
            <div class="md:hidden" id="mobile-menu">
                <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                    ...
                    <a href="{{ route('jobs.index') }}"
                        class="{{ request()->is('jobs.index') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }} block rounded-md px-3 py-2 text-base font-medium ">Jobs</a>
        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 flex flex-row items-start justify-between">
                <h1 class="text-3xl font-bold tracking-tight text-gray-900">{{ $heading }}</h1>
                <x-button href="{{ route('jobs.create') }}">Create Jobs</x-button>
            </div>
        </header>
        <main>
