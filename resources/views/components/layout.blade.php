                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <x-nav-link href="{{ route('jobs') }}" :active="request()->is('jobs')">Jobs</x-nav-link> <x-nav-link
                                    href="{{ route('contact') }}" :active="request()->is('contact')" type="button">Contact</x-nav-link>
